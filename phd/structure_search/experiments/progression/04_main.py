"""Step 4 — Connection-Level Feature Search main run at the best LR.
...
STUDY_NAME = f'{MLFLOW_PROJECT}/step4_lr_sweep'
RUN_NAME = 'step4_connection_level_main'
...
def best_lr(study: optuna.Study) -> float:
    ...
    if not completed:
        raise RuntimeError(
            f'No completed trials in {STUDY_NAME}. Run 04_lr_sweep.py first.')
