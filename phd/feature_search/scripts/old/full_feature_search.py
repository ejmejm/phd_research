...
def run_experiment(
    ...
    log_feature_matched_optimizer_stats = cfg.train.get('log_feature_matched_optimizer_stats', False)
    ...
    while step < cfg.train.total_steps:
        ...
        if step % cfg.train.log_freq == 0:
            ...
            if log_feature_matched_optimizer_stats and isinstance(optimizer, IDBD):
